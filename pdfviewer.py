# from https://www.codespeedy.com/how-to-create-a-pdf-viewer-using-python/
...
pdf_frame = Frame(root).pack(fill=tk.BOTH,expand=1)
...
pages = convert_from_path('audiobooktest.pdf',size=(800,900))
